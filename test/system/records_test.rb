...
class RecordsTest < ApplicationSystemTestCase
  ...
  test "should create record" do
    ...
    fill_in "Expenditure amount", with: @record.expenditure_amount
    fill_in "Expenditure category", with: @record.expenditure_category
    fill_in "Expenditure details", with: @record.expenditure_details
    fill_in "Income amount", with: @record.income_amount
    fill_in "Income details", with: @record.income_details
